...
@section('main')
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-target="#Add_UniNegocios"><i class="mdi mdi-plus-circle"></i> Agregar</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary" rel="tooltip" data-toggle="modal" data-target="#EditUnidadNegocio{{ $list->UNI_ID }}">
